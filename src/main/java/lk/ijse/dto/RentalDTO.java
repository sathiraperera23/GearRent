...
public class RentalDTO {
    ...
    public RentalDTO(long rentalId, long customerId, long equipmentId, LocalDate rentedFrom, LocalDate rentedTo,
                     BigDecimal dailyPrice, BigDecimal securityDeposit, long reservationId, String status, Timestamp createdAt) {
